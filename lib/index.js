...
(function () {
    ...
    const EPub = class EPub {
        constructor(options, output) {
            ...
            if (this.options.version === 2) this.options.docHeader = `<?xml version="1.0" encoding="UTF-8"?>\n<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.1//EN" "http://www.w3.org/TR/xhtml11/DTD/xhtml11.dtd">\n<html xmlns="http://www.w3.org/1999/xhtml" lang="${self.options.lang}">`;
            else this.options.docHeader = `<?xml version="1.0" encoding="UTF-8"?>\n<!DOCTYPE html>\n<html xmlns="http://www.w3.org/1999/xhtml" xmlns:epub="http://www.idpf.org/2007/ops" lang="${self.options.lang}">`;

            if (_.isString(this.options.author)) this.options.author = [this.options.author];
            if (_.isEmpty(this.options.author)) this.options.author = ["anonymous"];
            if (!this.options.tempDir) this.options.tempDir = path.resolve(__dirname, "../tempDir/");
        ...
        genEpub = () => {
            // Thanks to Paul Bradley: http://www.bradleymedia.org/gzip-markdown-epub/ (404 as of 28.07.2016)
            // Web Archive URL: http://web.archive.org/web/20150521053611/http://www.bradleymedia.org/gzip-markdown-epub
            // or Gist: https://gist.github.com/cyrilis/8d48eef37fbc108869ac32eb3ef97bca
            ...
            archive.on("end", function () {
                ...
                return rimraf(cwd, function (err) {
                    if (err) return genDefer.reject(err);
                    else return genDefer.resolve();
                });
                */
            });
            archive.on("error", function (err) { return genDefer.reject(err); });
            archive.finalize();
